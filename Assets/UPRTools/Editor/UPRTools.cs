    ...
    public class UPRTools : EditorWindow
{
    ...
    Rect multiColumnTreeViewRect
    {
        get
        {
            ...
            return new Rect(ui_DefaultMargin, y + ui_ModuleMargin, position.width - 2 * ui_DefaultMargin, position.height - y - ui_SettingsAreaHeight - ui_ModuleMargin);
        }
    }
    ...
    Rect uploadResultViewRect
    {
        get
        {
            return new Rect(ui_DefaultMargin, position.height - ui_SettingsAreaHeight, position.width - 2 * ui_DefaultMargin, ui_SettingsAreaHeight);
        }
    } 
